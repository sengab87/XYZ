...
public final class AddressViewController: UIViewController {
    ...
    public var address: Address?{
        //// address is set after the viewDidLoad /// //// Model telling the view that something changed in Model so to update View ////
        didSet {
    ...
    //// View telling Controller that smthg changed in and model need to be updated /////
